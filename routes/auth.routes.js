...
delete userWithoutPass.password // aqui borro lo de password del user.. asi ya no envio la info en el post.


        // Bind the user to the session object
        req.session.user = userWithoutPass
        console.log("el usuario creado pero sin password", req.session.user )
        res.redirect("/");
      })
      .catch((error) => {
